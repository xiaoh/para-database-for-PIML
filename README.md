...
- Dr. Laizet added a *new database with 27 simulations* (3 different heights, 3 different streamwise extents and 3 different hill shapes). For details see: ``pehill_new_DNS_database/README_NEWDATABASE.pdf`` [Description of new datasets]{pehill_new_DNS_database/README_NEWDATABASE.pdf}
